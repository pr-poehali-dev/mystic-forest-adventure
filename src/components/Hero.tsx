  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/532e329d-334e-43dc-8293-783ede525737/files/17a1d9a1-d08c-4073-a2ae-0ba5064b7390.jpg"
          alt="Роскошное оформление мероприятия"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Студия декора мероприятий"}</p>
          ...
          >
            {"Гильдия"}
            <br />
            <span className="text-orange-200">{"декораторов"}</span>
          </h1>
        </div>
      </div>
